    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-main">
          ...
          <div className="footer-links">
            <div className="footer-column">
              <h4>Services</h4>
              <ul>
                <li><Link to="/services">Car & SUV Washing</Link></li>
                <li><Link to="/services">Truck Washing</Link></li>
                <li><Link to="/services">Trailer Washing</Link></li>
                <li><Link to="/services">Crane Washing</Link></li>
        ...
        <div className="footer-bottom">
          <p>&copy; {new Date().getFullYear()} AA Fleet Wash. All rights reserved.</p>
